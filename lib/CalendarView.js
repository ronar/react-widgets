  ...
  CalendarViewCell.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      'td',
      {
        ...
        className: (0, _classnames2.default)('rw-grid-cell', this.isOffView() && 'rw-off-range', this.isFocused() && 'rw-state-focus', this.isSelected() && 'rw-state-selected', this.isEmpty() && 'rw-empty-cell')
      },
      _react2.default.createElement(
        'span',
        {
          ...
          className: (0, _classnames2.default)('rw-btn', this.isNow() && 'rw-now')
        },
        children
      )
    );
