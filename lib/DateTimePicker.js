...
var DateTimePicker = _react2.default.createClass((_obj = {
  ...
  renderCalendarWithTime: function renderCalendarWithTime(calId, timeId, inputID) {
    var _this = this;
    ...
    var _props3 = this.props,
        ...
        timeComponent = _props3.timeComponent,
        preserveDate = _props3.preserveDate;
    ...
    return (
      ...
      _react2.default.createElement(
        'div',
        null,
        calendar && _react2.default.createElement(Calendar, _extends({}, calendarProps, {
          ref: 'calPopup',
          id: calId,
          tabIndex: '-1',
          value: value,
        ...
        time && _react2.default.createElement(_TimeList2.default, _extends({}, timeListProps, {
          ref: 'timePopup',
          id: timeId,
          format: timeFormat,
  ...
  renderTimeList: function renderTimeList(id, inputID) {
    ...
    return _react2.default.createElement(_TimeList2.default, _extends({}, timeListProps, {
      ref: 'timePopup',
      id: id,
      format: timeFormat,
      value: dateOrNull(value),
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        shouldRenderList && this.renderCalendarWithTime(dateListID, timeListID, inputID)
      )
    );
  },
  ...
  open: function open(view) {
    if (this.props.open !== view) (0, _widgetHelpers.notify)(this.props.onToggle, view);
  },
