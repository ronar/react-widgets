...
exports.default = _react2.default.createClass({
  ...
  propTypes: {
    ...
    timeSlots: _react2.default.propTypes.array,
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      'div',
      { className: 'rw-timelist' },
      _react2.default.createElement(
        'div',
        { className: 'rw-timelist-header' },
        '2. What time?'
      ),
      _react2.default.createElement(_List2.default, _extends({}, _3.default.omitOwnProps(this), {
        ref: 'list',
        data: times,
        textField: 'label',
        valueField: 'date',
  ...
  _dates: function _dates(props) {
    ...
    if (props.timeSlots.length !== 0) {
      props.timeSlots.forEach(function (v) {
        values = _this._dateValues(_extends({}, props, {
          min: v.startTime,
          max: v.endTime
        }));
  ...
  handleKeyPress: function handleKeyPress(e) {
    ...
    this.search(String.fromCharCode(e.which), function (item) {
      _this2.isMounted() && _this2.setState({ focusedItem: item });
    });
  },
